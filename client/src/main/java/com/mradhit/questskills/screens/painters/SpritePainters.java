package com.mradhit.questskills.screens.painters;
...
public class SpritePainters implements BackgroundPainter {
    ...
    public SpritePainters(Identifier texture, int width, int height){
        this(texture, width, height, 0, 0, 1, 1);
    }

    public SpritePainters(Identifier texture, int width, int height, float cropLeft, float cropTop, float cropRight, float cropBottom){
